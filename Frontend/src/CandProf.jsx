...
const CandProf = () => {
  ...
  // Separate useEffect to fetch interviews when interviews tab is active
  useEffect(() => {
          ...
          <div className="cp-modal-body">
            ...
            {activeTab === 'interviews' && (
              <div className="cp-tab-content">
                ...
                {loadingInterviews ? (
                  <div className="cp-loading">Loading interviews...</div>
                ) : (
                  <>
                    {interviews.length > 0 ? (
                      interviews.map((interview) => (
                        <div key={interview.interview_id} className="cp-interview-item">
                          <div className="cp-interview-header">
                            <h5 className="cp-interview-title">
                          ...
                          <div className="cp-interview-meta">
                            <div>
                              ...
                              {interview.interviewer_position && ` (${interview.interviewer_position})`}
                            </div>
                            <div>
                              <strong>Location:</strong> {interview.location_or_link}
                            </div>
                            <div>
